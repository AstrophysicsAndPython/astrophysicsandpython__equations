...
class TimeDilation:
    ...
    def time_dilation(self, rest_frame_time: Optional[float], velocity: Optional[float]) -> float:
    ...
    def solver(self, rest_frame_time: Optional[float], relativistic_frame_time: Optional[float], velocity: Optional[float]) -> float:
